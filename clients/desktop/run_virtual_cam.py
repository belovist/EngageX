"""
Virtual camera client for meeting apps (Zoom, Google Meet, Teams).
Captures webcam, runs inference, sends scores to backend, and publishes to virtual camera.
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--gaze-model-path", default="models/l2cs_net.onnx", help="Path to L2CS ONNX model")
