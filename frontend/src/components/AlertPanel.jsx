        ...
        return (
          ...
          >
            <div className="pt-0.5">
              {isCritical ? <AlertCircle size={18} /> : isWarning ? <AlertTriangle size={18} /> : <Bell size={18} />}
            </div>
            ...
            <button onClick={() => onDismiss(alert.id)} className="text-gray-400 hover:text-white transition-colors">
              <X size={16} />
            </button>
          </div>
        );
